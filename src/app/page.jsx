...
export default function LandingPage() {
  return (  
    ...
    <h1 className="tracking-widest text-2xl font-normal">Web tilgængeligheds validator</h1>
    <img src="/diversa_frontpage.svg" alt="logo" height={300} width={300}	className="mb-12 mt-2"/>

    <p className="text-3xl mb-7 md:leading-normal">Få dit website tjekket for tilgængelighed - <br /> <span className="text-orange">gratis og øjeblikkeligt resultat!</span>
    </p>
