...
export default async function Page() {
    ...
    return (
      <main className="p-16 items-center max-w-screen-lg mt-12">
       <div>
        <h1 className="text-4xl font-semibold mb-12 ">Regler for webtilængelighed </h1>
      ...
      <ul className="space-y-7">
        {data.map(rule => (
          ...
          <button className="bg-orange text-white text-base p-1.5 px-5 rounded-xl hover:bg-bannerBlue"><Link href={`/rules/${rule.rulename}`} prefetch={false}>
            Læs mere
            </Link>
            </button>
          </li>
