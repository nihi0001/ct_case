    ...
    return (
      <main className="p-16 items-center max-w-screen-lg mt-12">
       <div>
        ...
        <p className="text-base text-grey-80 mb-7 max-w-[38rem]">Webtilgængelighed garanterer, at mennesker med handicap eller funktionsnedsættelser kan bruge offentlige hjemmesider og mobilapps uden barrierer. Dette indebærer at sikre, at indholdet er let at navigere, forståeligt og tilgængeligt for alle. </p>
